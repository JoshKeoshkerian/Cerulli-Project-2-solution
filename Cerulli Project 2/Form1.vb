...
Public Class frmMain
    ...
    Private Sub ClearOutput(sender As Object, e As EventArgs) _
        Handles cboAllowances.TextChanged, lstHours.SelectedIndexChanged, lstRates.SelectedIndexChanged, radMarried.CheckedChanged, radSingle.TextChanged, txtName.TextChanged
